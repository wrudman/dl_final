...
def main():
	windows = get_data(file_path="/gpfs/data/ceickhof/ecg_data/data/ar_data/files")
	make_spec(windows, target_directory="/gpfs/data/ceickhof/ecg_data/data/ar_spec", ecg_type="ar")
