...
def main():
	windows = get_data(file_path="/gpfs/data/ceickhof/ecg_data/data/sv_data/files")
	make_spec(windows, target_directory="/gpfs/data/ceickhof/ecg_data/data/sv_spec", ecg_type="sv")
